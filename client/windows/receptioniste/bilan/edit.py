...
class EditBilan(Window):
    ...
    def build(self, root):
        ...
        root.pack()
        self.prix = customtkinter.StringVar(value=bilan["analyse_prix"])
        self.selected_analyse_id = bilan["analysis_id"]
        ...
        self.nom_patient = customtkinter.StringVar(value=bilan["nom"])
        ...
        self.prenom_patient = customtkinter.StringVar(value=bilan["prenom"])
        customtkinter.CTkEntry(
        ...
        self.selected_analysis = customtkinter.StringVar(value=bilan["analyse_nom"])
        ...
        self.abrv = customtkinter.StringVar(value=bilan["analyse_abreviation"])
        ...
        self.date_visite = customtkinter.StringVar(value=bilan["date_visite"])
        ...
        enregistre = customtkinter.CTkButton(
            root, text="Enregistrer", command=self.edit_bilan
        )
    ...
    def edit_bilan(self):
        ...
        if not date_visite:
            ...
            Message(
                "edit_bilan",
                {
                    "bilan_id": self.data["bilan"]["bilan_id"],
                    "analyse_id": self.selected_analyse_id,
                    "patient_id": self.data["bilan"]["patient_id"],
